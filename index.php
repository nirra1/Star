...
<center><div style="font-family:sans-serif; font-size: 40pt">
...
<br>
 <center><a href="http://nirtoken.byethost7.com/?i=2"  style="border:none; background:red; height:30px; width:100px; border-radius:15px;" target="_blank">Get token</a> </div> </br> </center><div id="top-content"> <br> <br><div id="search-form">
<form action="index.php" method="post">

<input class="search" type="text" style="height:50px;" name="access_token" placeholder="paste your token here" required><br> <br>
